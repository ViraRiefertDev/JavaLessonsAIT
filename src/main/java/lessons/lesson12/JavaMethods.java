...
/*
 если метод static, то методы этого класса можно вызывать без создания объекта
 static метод видит только static переменные и static методы внутри этого класса

 static не нужен если методы будут в классе, в котором нет main, и в главном классе main мы вызываем эти методы не
 статичные через создание объекта этого класса
